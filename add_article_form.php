      ...
      <ul class="nav-links">
        ...
        <li>
            <a href="#">
              ...
              <span class="links_name">Add Article</span>
            </a>
          </li>
  ...
  <section class="home-section">
    ...
    <div class="container mt-5">
      ...
      <div class="col-12" style = "padding: 10px 20px 10px">
        ...
        <textarea class="form-control autogrow" placeholder="Write your content here" id="content" oninput="autoResize(this)" required></textarea>
      </div>
